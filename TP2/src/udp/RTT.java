...
public final class RTT {
    ...
    protected static final int MILLIS_OF_SLEEP = 20000; //11s

    private static final Lock lock = new ReentrantLock();
    private static long RTT_SUM = 0;
    private static long COUNT = 0;
    protected static long ESTIMATED_RTT = 1000;         //20 ms of initial estimated RTT
    ...
    protected static void add(long timestamp){
        ...
        RTT_SUM += (t - timestamp);
        COUNT++;
        ESTIMATED_RTT = (RTT_SUM / COUNT) * 2 + 5; //error interval
        lock.unlock();
    }
}
